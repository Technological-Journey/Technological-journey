...
.buildAndRegister() as Multiblock;
 ...
 chaos_replicator.recipeMap.recipeBuilder()
    .notConsumable(<contenttweaker:refinedchaoscrystal>)
    .inputs(<gregtech:meta_item_1:32724>,<gregtech:meta_item_1:32725>,<gregtech:meta_item_1:32726>)
    .fluidInputs(<liquid:uumatter> * 2000)
    .outputs(<contenttweaker:refinedchaosshard> * 6)
    .duration(500)
    .EUt(524288)
    .buildAndRegister();
