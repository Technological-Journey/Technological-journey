...
.outputs(<draconicadditions:chaotic_staff_of_power>.withTag({DEUpgrades: {attackDmg: 0 as byte, digSpeed: 0 as byte, digAOE: 0 as byte, rfCap: 0 as byte, attackAOE: 0 as byte}, Energy: 0, isStable: 0 as byte}))
...
.outputs(<draconicadditions:chaotic_bow>.withTag({DEUpgrades: {arrowDmg: 0 as byte, arrowSpeed: 0 as byte, drawSpeed: 0 as byte, rfCap: 0 as byte}, Energy: 0, isStable: 0 as byte}))
.fluidInputs(coolingfluid * chaoticFluidCost)
.fluidOutputs(heatedfluid * chaoticFluidCost)
.duration(Dur)
.EUt(chaoticVoltage)
