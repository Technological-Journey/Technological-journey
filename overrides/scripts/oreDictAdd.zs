...
<ore:blockWarpCoreRim>.remove(<libvulpes:metal0:7>);
	...
	<ore:ingotCosmicNeutronium>.remove(<gregtech:compressed_17>);
...
h(<thermalexpansion:frame:128>);
h(<thermalexpansion:frame:129>);
h(<thermalexpansion:frame:148>);
h(<thermalexpansion:frame:147>);
h(<thermalexpansion:frame:146>);
h(<thermalexpansion:frame:132>);
h(<thermalexpansion:frame:131>);
h(<thermalexpansion:frame:130>);
h(<simplyjetpacks:itemjetpack:1>.withTag({}));
h(<simplyjetpacks:itemjetpack:2>.withTag({}));
h(<simplyjetpacks:itemjetpack:3>.withTag({}));
h(<simplyjetpacks:itemjetpack:24>.withTag({JetpackParticle: 0}));
h(<simplyjetpacks:itemjetpack:23>.withTag({JetpackParticle: 0}));
h(<simplyjetpacks:itemjetpack:22>.withTag({JetpackParticle: 0}));
h(<simplyjetpacks:itemjetpack:21>.withTag({JetpackParticle: 0}));
h(<simplyjetpacks:itemfluxpack:11>.withTag({Energy: 0}));
h(<simplyjetpacks:itemjetpack:19>.withTag({Energy: 0, JetpackParticle: 0}));
h(<simplyjetpacks:itemfluxpack:12>.withTag({Energy: 0}));
h(<simplyjetpacks:itemfluxpack:13>.withTag({Energy: 0}));
h(<simplyjetpacks:itemfluxpack:14>.withTag({Energy: 0}));
h(<simplyjetpacks:itemjetpack:16>.withTag({Energy: 0, JetpackParticle: 0}));
h(<simplyjetpacks:itemjetpack:17>.withTag({Energy: 0, JetpackParticle: 0}));
h(<simplyjetpacks:itemjetpack:18>.withTag({Energy: 0, JetpackParticle: 0}));
h(<simplyjetpacks:itemjetpack:20>.withTag({JetpackParticle: 0}));
//hide TE nugets
...
h(<simplyjetpacks:itemfluxpack:7>.withTag({Energy: 0}));
h(<simplyjetpacks:itemfluxpack:8>.withTag({Energy: 0}));
h(<simplyjetpacks:itemfluxpack:9>.withTag({Energy: 0}));
h(<simplyjetpacks:itemfluxpack:10>.withTag({Energy: 0}));
//h(<simplyjetpacks:metaitemmods:24>);
h(<thermalexpansion:cell>.withTag({Recv: 1000, RSControl: 0 as byte, Facing: 3 as byte, Energy: 0, SideCache: [2, 1, 1, 1, 1, 1] as byte[] as byte[], Level: 0 as byte, Send: 1000}));
h(<simplyjetpacks:metaitemmods:24>);
// remove TE ingots
...
<avaritia:resource:4>.displayName = "Cosmic Neutronium";
furnace.remove(<gregtech:meta_item_1:10712>);
<avaritia:resource:3>.displayName = "Cosmic Neutronium Nugget";
<avaritia:resource:3>.displayName = "Cosmic Neutronium Nugget";
<draconicevolution:draconium_block:1>.addTooltip(format.darkRed("Do not place this block in world"));
<avaritia:block_resource>.displayName = "Cosmic Neutronium Block";
h(<avaritia:neutronium_compressor>);
h(<avaritia:singularity>);
h(<avaritia:singularity:1>);
h(<avaritia:singularity:2>);
h(<avaritia:singularity:3>);
h(<avaritia:singularity:4>);
h(<avaritia:singularity:5>);
h(<avaritia:singularity:6>);
h(<avaritia:singularity:7>);
h(<avaritia:singularity:8>);
h(<avaritia:singularity:9>);
h(<avaritia:singularity:10>);
h(<avaritia:singularity:11>);
h(<avaritia:singularity:12>);
h(<avaritia:singularity:13>);
h(<avaritia:singularity:14>);
h(<avaritia:neutron_collector>);
